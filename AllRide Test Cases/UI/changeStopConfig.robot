...
Change description rf
    ...
    ...    data={"name":"Hospital Rengo","description":"","communities":["6654ae4eba54fe502d4e4187"],"superCommunities":["653fd68233d83952fafcd4be"],"ownerIds":[{"_id":"6654d533713b9a5184cfe31d","id":"6654ae4eba54fe502d4e4187","role":"community"}],"categories":["odd"],"lat":-34.4111,"lon":-70.8537,"config":{"options":[{"direction":"in","day":"fri","time":"02:00","description":"Descripcion hola","grouping":{"byKey":{"enabled":false,"key":""},"byList":{"enabled":false,"list":[]}},"restricted":{"userLocation":{"enabled":true},"stops":{"enabled":false,"stopIds":[]}}}],"restricted":false,"stopIds":[]}}
    ...    headers=${headers}
