...
Modify Hospital Rengo -- Entry, Description, Just Hours, No Agrupation, User Stop Restriction
    ...
    ...    data={"name":"Hospital Rengo","description":"","communities":["6654ae4eba54fe502d4e4187"],"superCommunities":["653fd68233d83952fafcd4be"],"ownerIds":[{"_id":"6654d533713b9a5184cfe31d","id":"6654ae4eba54fe502d4e4187","role":"community"}],"categories":["odd"],"lat":-34.4111,"lon":-70.8537,"config":{"options":[{"direction":"in","day":"fri","time":"02:00","description":"Descripcion1 Hola","grouping":{"byKey":{"enabled":false,"key":""},"byList":{"enabled":false,"list":["A","B"]}},"restricted":{"userLocation":{"enabled":true},"stops":{"enabled":false,"stopIds":["666728c8fea8eb2b26b20e82"]}},"labels":{"time":true,"custom":["etiqueta1"]}}],"restricted":false,"stopIds":[]}}
    ...    headers=${headers}
...
Select Service (Taxis Nico Not Visible Or Calendar Not Working)
...
Cancel calendar and Back To main Screen
    ${el1} =    Set Variable     id=com.allride.core:id/btnCancel
    Click Element    ${el1}
    ${el2} =    Set Variable     id=com.allride.core:id/btnBack
    Click Element    ${el2}
    ${el3} =    Set Variable     id=com.allride.core:id/btnBack
    Click Element    ${el3}

Tap on Search Bar (Origin)2
    ${barraBusqueda} =    Set Variable     id=com.allride.core:id/etSearch
    Wait Until Element Is Visible    ${barraBusqueda}
    Click Element    ${barraBusqueda}

    ${el13} =    Set Variable     id=com.allride.core:id/etOrigin
    Wait Until Element Is Visible    ${el13}
    Click Element    ${el13}
Tap on User Stops
    ${ownDirection}=    Set Variable     xpath=(//android.widget.ImageView[@resource-id="com.allride.core:id/ivLogo"])[1]
    Wait Until Element Is Visible    ${ownDirection}
    Click Element    ${ownDirection}
...
Check Tags
    ${etiqueta1}=    Set Variable     xpath=//android.widget.TextView[@text="etiqueta1"]
    Click Element    ${etiqueta1}
