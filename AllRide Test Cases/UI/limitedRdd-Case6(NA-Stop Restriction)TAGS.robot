...
Modify Hospital Rengo -- Entry, Description, Just Hours, No Agrupation, Stops Restrictions Minuto Verde
...
Back To Main screen
    ${backBtn}=    Set Variable     id=com.allride.core:id/btnBack
...
Search Minuto Verde (Restricted Stop)
    ${el14} =    Set Variable     id=com.allride.core:id/etOrigin
    Wait Until Element Is Visible    ${el14}
    Click Element    ${el14}
    Input Text    ${el14}    minuto verde

Tap On Origin (Minuto Verde)
    ${el15} =     Set Variable     id=com.allride.core:id/ivLogo
    Wait Until Element Is Visible    ${el15}
    Click Element    ${el15}
