...
Round Full Online (Just Stops)
    ...
    Set Location    -33.39069067866545     -70.54616911743602

Set Starting Locations
    Set Location    -33.486422203122174    -70.5186598671542
    Sleep    10s
Set Location to Pregrado
    Set Location    -33.486422203122174    -70.5186598671542
    Sleep    120s

Set Location to Solo estadisticas
    Set Location    -33.489047    -70.516463
    Sleep    120s

Set Location to Talleres
    Set Location    -33.490728034237705    -70.51458141625595
    Sleep    120s
    
Set Location to Postgrado
    Set Location    -33.492981    -70.512787
    Sleep    120s
