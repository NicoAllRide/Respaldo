...
Start Departure Leg
    ...
    ...    data={"communityId":"${idComunidad}","startLat":-33.3908833,"startLon":-70.54620129999999,"customParamsAtStart":[],"preTripChecklist":[],"routeId":"66ba4462f0e937e4b99413a2","capacity":40,"busCode":"0602","vehicleId":"65b13780fd1711a264653aa1","shareToUsers":false,"customParams":[],"pin":null}
    ...    headers=${headers}
    # Verifica el código de estado esperado (puedes ajustarlo según tus expectativas)
    ${code}=    convert to string    ${response.status_code}
    Status Should Be    200
...
Sync Departures Offline(departure already created, sync as active departure)
    Set Log Level    TRACE
    Create Session    mysesion    ${STAGE_URL}    verify=true
