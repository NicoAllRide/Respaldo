...
Create Driver Daily Payment (Driver and Route must go with Shape File due to the shape an route id)
    ...
    ...    data={"name":"Conductor RF Pago Diario","username":"ConductorRFD","identifier":"123456755-8","code":"131","phone":"+56976493312","communities":["666b08f0d574cd44de5885e1"],"routes":["666b2bd9bfaab8adfaf53f25"],"paymentFrecuency":"daily","feePrice":100,"password":"Lolowerty123"}
    ...    headers=${headers}
...
Create Driver Weekly Payment
    ...
    ...    mysesion
    ...    url=/api/v1/admin/cp/drivers
    ...    data={"name":"Conductor RF Pago Diario1","username":"ConductorRFW","identifier":"19186681-9","code":"133","phone":"+56976493312","communities":["653fd601f90509541a748683"],"routes":["6659f8e2dd9a7b2a3d9b58ba"],"paymentFrecuency":"daily","feePrice":100,"password":"Lolowerty123"}
    ...    headers=${headers}
    # Verifica el código de estado esperado (puedes ajustarlo según tus expectativas)
    ${code}=    convert to string    ${response.status_code}
    Status Should Be    200
