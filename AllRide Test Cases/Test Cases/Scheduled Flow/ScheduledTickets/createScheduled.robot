...
Resource Assignment(Driver and Vehicle)
    ...
    ${response}=    POST On Session
    ...    mysesion
    ...    url= /api/v1/admin/pb/assignServiceResources/${serviceId}?community=${idComunidad}
