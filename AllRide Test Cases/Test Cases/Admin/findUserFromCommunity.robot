...
##Acá podría sacar al usuario de la comunidad, verificar que la reserva ya no exista, pero creo que voy a tener que implementar una prueba más a esto, quizás sin tener que ejecutar una creación de reserva
