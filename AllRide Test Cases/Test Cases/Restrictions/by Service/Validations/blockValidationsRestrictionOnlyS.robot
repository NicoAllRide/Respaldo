...
Validate With QR(User 2 Only this user can validate)
    Create Session    mysesion    ${STAGE_URL}    verify=true
    ...
    Log    ${code}
    Sleep    10s
Validate With QR(Nico Should Fail)
    Create Session    mysesion    ${STAGE_URL}    verify=true
