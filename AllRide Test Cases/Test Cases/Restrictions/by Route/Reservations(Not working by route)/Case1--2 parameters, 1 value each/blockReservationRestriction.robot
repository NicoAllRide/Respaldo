...
Seat Reservation(User1-Nico Should be not be able to make reservation EXPECT ERROR)
    Create Session    mysesion    ${STAGE_URL}    verify=true
    # Define la URL del recurso que requiere autenticación (puedes ajustarla según tus necesidades)
...
Seat Reservation(User2-Should be able to make reservation)
    Create Session    mysesion    ${STAGE_URL}    verify=true
    # Define la URL del recurso que requiere autenticación (puedes ajustarla según tus necesidades)
