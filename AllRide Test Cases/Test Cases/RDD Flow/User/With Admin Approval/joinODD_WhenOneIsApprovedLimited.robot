...
Get Places
    [Documentation]     Obtiene la lista de lugares disponibles para una comunidad específica y verifica que no esté vacía.
...
Get ODD Details
    ...
    Should Be True    ${total_reservas} == 1    msg=❌ Debería haber una reserva y se encontraron más
